...
void EditMeshOperator::onEnter(View&)
{
    m_idle = true;
}

void EditMeshOperator::onExit(View&)
{
    clear();
}
...
void EditMeshOperator::onMouseInput(View& view, ButtonCode button, Action action, Modifier mods, double x, double y)
{
...
void EditMeshOperator::onKeyboardInput(View& view, KeyCode key, Action action, Modifier mods)
{

}

void EditMeshOperator::clear()
{
    if (m_manipulator)
    {
...
void EditMeshOperator::setupTriad()
{
...
void EditMeshOperator::setupArrow()
{
