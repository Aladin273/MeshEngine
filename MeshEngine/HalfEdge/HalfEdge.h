...
namespace heds
{
    ...
    public:
        ...
        Vertex<T>& deref(VertexHandle vh)
        {
            return m_vertices[vh.index];
        }

        const Vertex<T>& deref(VertexHandle vh) const
        {
            return m_vertices[vh.index];
        }

        VertexHandle handle(const Vertex<T>& v) const
        {
        ...
        const T& getPoint(VertexHandle handle) const
        {
            return m_vertices[handle.index].data;
        }

        void setPoint(VertexHandle handle, T point)
        {
