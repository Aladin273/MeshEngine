...
bool glm::intersectRayTriangle(glm::vec3 ray_orig, glm::vec3 ray_dir, float& t, glm::vec3 v0, glm::vec3 v1, glm::vec3 v2)
{
...
bool glm::intersectRayRay(glm::vec3 a_orig, glm::vec3 a_dir, glm::vec3 b_orig, glm::vec3 b_dir, glm::vec3& point)
{
    // Skew lines
